...
class DRAW(object):
    ...
    def step(self, cell_enc, cell_dec, hid_enc, hid_dec,
        ...
        new_cell_enc, new_hid_enc = self.q_rnn.fprop(
            [x, x_err, cell_enc, hid_enc, hid_dec],
            self.srng,
            deterministic=deterministic)
        ...
        return new_cell_enc, new_cell_dec, new_hid_enc,\
            new_hid_dec, new_canvas, z, kl
    ...
    def lowerbound(self):
        ...
        outputs_info = [init_cell_enc, init_cell_dec, init_hid_enc,
                        init_hid_dec, init_canvas, None, None]
    ...
    def p_sample_mean_given_x(self):
        ...
        [cell_dec, hid_dec, canvas], scan_updates = theano.scan(
            fn=p_step,
